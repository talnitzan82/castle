...
$impDetails['cost'] = is_numeric($_GET['cost']) ? $_GET['cost'] : 0;
$impDetails['bid'] = is_numeric($_GET['bid']) ? $_GET['bid'] : 0;
$impDetails['camp_id'] = is_numeric($_GET['camp_id']) ? $_GET['camp_id'] : 0;
$impDetails['creative_id'] = is_numeric($_GET['creative']) ? $_GET['creative'] : 0;
